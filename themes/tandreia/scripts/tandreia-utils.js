/**
 * copy from official paginator.js, change the html present
 */
hexo.extend.helper.register("paginator2", function(options) {
    options = options || {};
    ...
    var currentPage = '<span class="item active">' +
    ...
    function pageLink(i) {
        return '<a class="item" href="' + link(i) + '">' +
    ...
    if (options.show_all) {
        ...
        var spaceHtml = '<span class="item">' + space + '</span>';
